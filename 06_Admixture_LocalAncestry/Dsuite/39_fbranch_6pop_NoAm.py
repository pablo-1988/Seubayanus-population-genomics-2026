...
D=f"{proj}/results/K5/sep_NoAm/02_dsuite"; OUT=f"{proj}/results/K5/figures_EN"
...
m.to_csv(f"{D}/fbranch_tidy_6pop_NoAm.tsv",sep="\t",index=False,float_format="%.5g")
...
# --- heatmap ---
recips=["PA","PB1","PB2","PB3","PB4","NoAm"]
...
ax.set_title("f-branch (pure lineages + NoAm (no Hol))\n* Z>1.96, ** Z>2.58, *** Z>3.29 (block jackknife)",
             fontweight="bold",fontsize=11)
plt.tight_layout()
fig.savefig(f"{OUT}/38_fbranch_6pop_NoAm.pdf",bbox_inches="tight")
fig.savefig(f"{OUT}/38_fbranch_6pop_NoAm.png",dpi=160,bbox_inches="tight")
print("\n-> fbranch_tidy_6pop_NoAm.tsv , 38_fbranch_6pop_NoAm")
