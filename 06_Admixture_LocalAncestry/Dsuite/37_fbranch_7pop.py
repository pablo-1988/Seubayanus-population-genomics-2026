...
D=f"{proj}/results/K5/sep_HolNoAm/02_dsuite"; OUT=f"{proj}/results/K5/figures_EN"
...
m.to_csv(f"{D}/fbranch_tidy_7pop.tsv",sep="\t",index=False,float_format="%.5g")
...
# --- heatmap ---
recips=["PA","PB1","PB2","PB3","PB4","Hol","NoAm"]
border=["b4","b5","b6","b7","b8","b9","b10","b11","b12","b13"]
blab={}
...
ax.set_title("f-branch (pure lineages + Hol + NoAm)\n* Z>1.96, ** Z>2.58, *** Z>3.29 (block jackknife)",
             fontweight="bold",fontsize=11)
plt.tight_layout()
fig.savefig(f"{OUT}/36_fbranch_7pop.pdf",bbox_inches="tight")
fig.savefig(f"{OUT}/36_fbranch_7pop.png",dpi=160,bbox_inches="tight")
print("\n-> fbranch_tidy_7pop.tsv , 36_fbranch_7pop")
