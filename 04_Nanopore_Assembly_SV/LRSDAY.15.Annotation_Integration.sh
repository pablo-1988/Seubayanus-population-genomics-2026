#!/bin/bash
# =============================================================================
# LRSDAY Step 15: Annotation Integration
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Merges all individual annotation tracks — centromeres, transposable
#   elements, Core X elements, Y-prime elements, nuclear genes, and
#   mitochondrial genes — into a single comprehensive GFF3 file representing
#   the complete genome annotation for the assembly.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   All individual annotation output files (GFF3/BED) from steps 05–14
#
# Output:
#   Final comprehensive genome annotation GFF3 file
#
# Dependencies:
#   BEDtools, custom LRSDAY scripts
#
