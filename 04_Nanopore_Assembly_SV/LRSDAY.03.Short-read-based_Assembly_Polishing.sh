#!/bin/bash
# =============================================================================
# LRSDAY Step 03: Short-Read-Based Assembly Polishing
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Further polishes the long-read assembly using Illumina short reads with
#   Pilon to correct single-nucleotide errors and small indels. Reads are
#   first aligned to the assembly with BWA, and the resulting BAM is passed
#   to Pilon for consensus correction.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Long-read polished assembly FASTA + Illumina paired-end FASTQ files
#
# Output:
#   Fully polished genome assembly FASTA
#
# Dependencies:
#   BWA, SAMtools, Pilon
#
...
if [[ $mode == "PE" ]]
then
    reads_PE1="./../00.Short_Reads/UCD646_1.fq.gz" # Please replace the PE reads file name for your own project
    reads_PE2="./../00.Short_Reads/UCD646_2.fq.gz" # Please replace the PE reads file name for your own project
else
