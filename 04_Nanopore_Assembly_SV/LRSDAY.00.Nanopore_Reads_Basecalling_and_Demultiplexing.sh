#!/bin/bash
# =============================================================================
# LRSDAY Step 00: Nanopore Reads Basecalling and Demultiplexing
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Performs basecalling of raw Nanopore FAST5 files using Guppy and
#   demultiplexes the resulting reads by barcode. Each barcode bin is
#   output as a separate FASTQ file for independent downstream processing.
#
...
#
# Output:
#   Per-barcode FASTQ files (one per demultiplexed sample)
#
# Dependencies:
#   Guppy (Oxford Nanopore Technologies basecaller)
#
