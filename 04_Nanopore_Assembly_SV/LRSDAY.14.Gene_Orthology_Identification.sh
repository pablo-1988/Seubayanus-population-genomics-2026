#!/bin/bash
# =============================================================================
# LRSDAY Step 14: Gene Orthology Identification
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Identifies orthologous gene pairs between the newly annotated genome and
#   the S. cerevisiae reference using ProteinOrtho. Orthology assignments are
#   used to transfer standard gene names from the reference to the query
#   genome annotation.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Predicted protein FASTA files (query genome + reference genome)
#
# Output:
#   Ortholog table (ProteinOrtho output) mapping query genes to reference names
#
# Dependencies:
#   ProteinOrtho
#
...
threads=12 # The number of threads to use. Default = "1".
