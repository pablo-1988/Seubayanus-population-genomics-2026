#!/bin/bash
# =============================================================================
# LRSDAY Step 04: Reference-Guided Assembly Scaffolding
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Orders and orients polished contigs into chromosomal scaffolds by aligning
#   them against a reference genome using Ragout. Gaps between contigs are
#   represented by runs of 5000 Ns, producing a chromosome-scale assembly
#   suitable for annotation and comparative analysis.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Polished assembly FASTA + reference genome FASTA
#
# Output:
#   Scaffolded genome assembly FASTA (contigs joined with 5000-N gaps)
#
# Dependencies:
#   Ragout, Sibelia
#
...
prefix="UCD646" # The file name prefix for processing sample. Please avoid the character '.' in prefix. Default = "SK1" for the testing example.
...
ref_genome_raw="./../00.Reference_Genome/CBS12357_polished_20170509.fa" # The file path of the raw reference genome.
ref_genome_noncore_masked="./../00.Reference_Genome/CBS12357.fasta" # The file path of the specially masked reference genome where subtelomeres and chromosome-ends were hard masked. When the subtelomere/chromosome-end information is unavailable for the organism that you are interested in, you can just put the path of the raw reference genome assembly here.
...
threads=6 # The number of threads to use. Default = "1".
