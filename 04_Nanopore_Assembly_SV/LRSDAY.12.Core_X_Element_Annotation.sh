#!/bin/bash
# =============================================================================
# LRSDAY Step 12: Core X Element Annotation
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Identifies telomeric Core X elements in the final assembly using nhmmer,
#   an HMM-based search tool from the HMMER suite. Core X elements are
#   subtelomeric repeats found adjacent to telomeres in Saccharomyces genomes.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Final assembly FASTA + Core X element HMM profile
#
# Output:
#   Core X element annotation file (coordinates and scores)
#
# Dependencies:
#   HMMER (nhmmer)
#
