#!/bin/bash
# =============================================================================
# LRSDAY Step 06: Mitochondrial Genome Assembly Improvement
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Extracts the mitochondrial contig from the nuclear assembly, improves its
#   sequence, and circularizes it using the ATP6 gene as a canonical starting
#   point. MUMmer alignments and custom scripts are used to verify and finalize
#   the circular mtDNA sequence.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Genome assembly FASTA (containing the mitochondrial contig)
#
# Output:
#   Circular mitochondrial genome FASTA
#
# Dependencies:
...
gene_start="./../00.Reference_Genome/ATP6.fa" # A FASTA file containing the CDS sequence of the mitochodnrial gene to be used as the starting point of the mitochondrial assembly. This can be set to any gene as long as a fasta file containing the DNA sequence of the gene is provided.
ref_genome_raw="./../00.Reference_Genome/CBS12357.fasta" # The file path of the raw reference genome 
