#!/bin/bash
# =============================================================================
# LRSDAY Step 09: Nuclear Gene Annotation
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Annotates nuclear protein-coding genes in the final assembly using MAKER,
#   incorporating protein homology evidence and EST alignments. Ab initio
#   gene prediction is supported by SNAP and Augustus models trained on
#   yeast gene structures.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Final assembly FASTA + protein database FASTA + EST/transcript sequences
#
# Output:
#   Gene annotation GFF3 file + predicted protein and transcript FASTAs
#
# Dependencies:
#   MAKER, SNAP, Augustus, BLAST
#
