#!/bin/bash
# =============================================================================
# LRSDAY Step 01: Long-Read-Based Genome Assembly
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Performs de novo genome assembly from filtered Nanopore long reads using
#   Flye (or alternatively Canu, wtdbg2, smartdenovo, or ra). The resulting
#   raw assembly serves as the starting point for subsequent polishing steps.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Filtered Nanopore FASTQ file (e.g., filtered_reads.fastq.gz)
#
# Output:
#   Raw genome assembly FASTA file
#
# Dependencies:
#   Flye (or Canu, wtdbg2, smartdenovo, ra)
#
...
threads=10 # The number of threads to use. Default = 4.
vcf="no" # Use "yes" if prefer to have vcf file generated to show SNP and INDEL differences between the assembled genome and the reference genome for their uniquely alignable regions. Otherwise use "no". Default = "yes".
...
then
    ref_genome_raw="./../00.Reference_Genome/CBS12357.fasta" # The file path of the raw reference genome. This is only needed when the option "dotplot" or "vcf" has been set as "yes".
else
