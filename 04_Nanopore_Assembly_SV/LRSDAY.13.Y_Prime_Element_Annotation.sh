#!/bin/bash
# =============================================================================
# LRSDAY Step 13: Y-Prime Element Annotation
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Identifies Y-prime subtelomeric elements in the final assembly using BLAT,
#   requiring at least 90% sequence identity and a minimum length of 1000 bp.
#   Y-prime elements are large subtelomeric repeats found near chromosome ends
#   in Saccharomyces species.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Final assembly FASTA + Y-prime element reference sequences (FASTA)
#
# Output:
#   Y-prime element annotation file (coordinates and identity scores)
#
# Dependencies:
#   BLAT
#
