#!/bin/bash
# =============================================================================
# LRSDAY Step 11: Transposable Element (TE) Annotation
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Annotates transposable elements in the final assembly using RepeatMasker
#   with a yeast TE library, with specific focus on identifying Ty1 and Ty2
#   LTR retrotransposons. Produces both a TE annotation GFF3 and a
#   repeat-masked version of the assembly.
#
...
#
# Output:
#   TE annotation GFF3 file + repeat-masked assembly FASTA
#
# Dependencies:
#   RepeatMasker, REannotate
#
