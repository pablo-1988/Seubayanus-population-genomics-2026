#!/bin/bash
# =============================================================================
# LRSDAY Step 07 (Part 2): Supervised Final Assembly — Apply Modifications
# Long-Read Sequencing Data Analysis Workflow (LRSDAY) — S. eubayanus
# =============================================================================
# Description:
#   Applies the user-defined modification list to the scaffolded assembly to
#   produce the final curated genome. Also generates assembly statistics, a
#   VCF-format comparison against the reference, and a whole-genome dotplot
#   for visual quality assessment.
#
# Example strain: UCD646 (Holarctic-admixed S. eubayanus, Oxford Nanopore)
#
# Input:
#   Scaffolded assembly FASTA + user-edited modification list
#
# Output:
#   Final curated assembly FASTA, assembly statistics, VCF comparison, dotplot
#
# Dependencies:
...
ref_genome_raw="./../00.Reference_Genome/CBS12357.fasta" # The path of the raw reference genome, only needed when dotplot="yes" or vcf="yes".
threads=8 # The number of threads to use. Default = 1.
